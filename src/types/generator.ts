 ...
 */
export const BUILT_IN_GENERATION_ALGORITHM_NAMES = [
    'BBS',
    'PCG',
    'AES-CTR',
    'ChaCha20',
...
/**
 * Represents the name of a built-in generation algorithm.
 *
 * Used to identify one of the algorithms registered by default in {@link AlgorithmFactory.registerBuiltIn}.
 */
export type BuiltInGenerationAlgorithmName = (typeof BUILT_IN_GENERATION_ALGORITHM_NAMES)[number]
 ...
 *
 * @remarks
 * This type provides autocomplete for built-in algorithm names while still allowing custom algorithm names.
 */
export type GenerationAlgorithmName = BuiltInGenerationAlgorithmName | (string & {})
