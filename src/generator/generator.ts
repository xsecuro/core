...
export class Generator {
     ...
     * ```
     */
    updateRequirements(requirements: GenerationRequirements[]): void {
     ...
     * ```
     */
    updateSeparator(separator: SeparatorKey): void {
     ...
     * ```
     */
    updateAlgorithm(algorithm: GenerationAlgorithm): void {
